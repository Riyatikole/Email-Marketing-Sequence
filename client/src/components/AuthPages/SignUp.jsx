...
import { FormControl, FormLabel, Input, Button, VStack, IconButton, InputGroup, InputRightElement, Flex, Box, Center, Link, Text, useToast} from '@chakra-ui/react';
...
export default function SignUp() {
    ...
    return(
        ...
        <Center >
          ...
          bgClip="text" fontSize={"25px"}>Register</Text>
          </Center>
            ...
            <Button bg="pink.300" _hover={{ bg: "pink.400" }} onClick={handleSubmit}>Sign Up</Button>
        </VStack>
        </Flex>
        </Flex>
        </Box>
